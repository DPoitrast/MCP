...
class Response:
    def __init__(self, status_code: int = 200, headers: _typing.Iterable[_typing.Tuple[str, str]] | None = None, stream: ByteStream | bytes | None = None, request: 'Request' | None = None):
...
class Request:
    def __init__(self, method: str, url: _typing.Union[str, URL], headers: dict[str, str] | None = None, content: _typing.Any = None):
        self.method = method
...
class Client:
    def __init__(self, *, app=None, base_url: str | None = None, headers: dict[str, str] | None = None, transport: BaseTransport | None = None, follow_redirects: bool = True, cookies=None, **kwargs):
        self.app = app
    ...
    def request(self, method: str, url: _typing.Union[str, URL], *, headers: dict[str, str] | None = None, content=None, data=None, json=None, params=None, files=None, cookies=None, auth=None, follow_redirects=None, timeout=None, extensions=None) -> Response:
        all_headers = {**self.headers, **(headers or {})}
        req = Request(method, self.build_url(url), headers=all_headers, content=content or data)
...
__all__ = [
    'ByteStream', 'Response', 'URL', 'Request', 'BaseTransport', 'Client', '_types', '_client'
]
